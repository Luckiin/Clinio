...
export async function middleware(requisicao: NextRequest) {
  ...
  // Se tem sessão e está tentando acessar página de login, redirecionar para painel
  if (session && (caminhoAtual === '/autenticacao/entrar' || caminhoAtual === '/autenticacao/registrar')) {
